...
export default function ContactSection() {
  return (
    <section id="contact" style={{ borderTop: "1px solid #222", paddingTop: "8rem", paddingBottom: "8rem" }} className="px-6 md:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-0 items-start">
          ...
          <div className="md:col-span-4">
            <p className="leading-relaxed mb-10" style={{ fontSize: "0.9rem", color: "#888", maxWidth: "34ch" }}>
          ...
          <div className="md:col-span-7 md:col-start-6" style={{ borderTop: "1px solid #222" }}>
            {LINKS.map(({ label, value, href }, i) => (
              <motion.a key={label} href={href}
                ...
                onMouseLeave={e => (e.currentTarget.style.borderBottomColor = "#222")}>
                <div className="flex items-center gap-8">
                  <span className="font-mono text-[9px] tracking-[0.25em] uppercase w-16" style={{ color: "#666" }}>
                    {label}
                  </span>
                  <span className="transition-colors duration-200"
                    style={{ fontSize: "0.95rem", color: "#999", fontFamily: "var(--font-geist-mono)" }}
                    onMouseEnter={e => (e.currentTarget.style.color = "#F5F5F2")}
                    onMouseLeave={e => (e.currentTarget.style.color = "#999")}>
                    {value}
                  </span>
                </div>
                <span className="font-mono text-[12px] opacity-0 group-hover:opacity-100 transition-all duration-200 translate-x-2 group-hover:translate-x-0"
                  style={{ color: "#C9B89A" }}>↗</span>
              </motion.a>
            ))}
          </div>
        </div>
        ...
        {/* Footer strip */}
        <div className="flex items-center justify-between mt-24 pt-8" style={{ borderTop: "1px solid #1E1E1E" }}>
          <span className="font-mono text-[8px] tracking-[0.2em] uppercase" style={{ color: "#555" }}>
